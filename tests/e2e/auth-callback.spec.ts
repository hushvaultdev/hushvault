...
test('oauth callback shows an error message for a denied GitHub sign-in', async ({ page }) => {
...
test('oauth callback shows an error message for a denied Google sign-in', async ({ page }) => {
  await page.goto('/auth/callback#error=google_denied')
